...
public class JavaQuest13 {
  ...
  private static double convertFahrenheit(double Fahrenheit) {
    return Fahrenheit * 1.80 + 32.00;
  }

  // public static double[] arr(double kelvin, double[] Fahrenheit) {
  // double celsius = 23.56d;
  // double[] arr = new double[] { convertKelvin(celsius),
  // convertFahrenheit(celsius) };

  // for (int i = 0; i < arr.length; i++) {
  // if (i == 0) {
  // return "Temperature in Kelvin: " + arr[i];
  // } else if (i == 1) {
  // return "Temperature in Fahrenheit: " + arr[i];
  // }
